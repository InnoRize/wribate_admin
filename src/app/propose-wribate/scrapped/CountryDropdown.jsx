...
const CountryDropdown = ({ formData,handleFormChange, keyString, title }) => {
    ...
    const handleCountrySelect = (country) => {
        handleFormChange(keyString, country);
        setIsCountryDropdownOpen(false);
        setCountrySearchTerm("");
    };
    ...
    return (
        <div className="grid gap-2">
            ...
            <div className="relative" ref={countryDropdownRef}>
                ...
                >
                    <span className={formData.revisedCountry ? "text-gray-900" : "text-gray-500"}>
                        {formData.revisedCountry || "Select a country"}
                    </span>
                                ...
                                filteredCountries.map((country) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2 text-sm hover:bg-gray-100 transition-colors
                                                                    ${formData.revisedCountry === country ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700'}
                                                    `}
                                    >
                                        {country}
                                    </button>
